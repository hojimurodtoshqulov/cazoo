...
const MainFilter: React.FC = () => {
	...
	const [filterWidth, setfilterWidth] = useState<Position>("100%");
	const listenScrollEvent = () => {
		window.scrollY > 450 ? setnavSize("fixed") : setnavSize("relative");
		window.scrollY > 450 ? setfilterWidth("30%") : setfilterWidth("100%");
	};
	const divStyle = {
		width: filterWidth,
		position: navSize,
	...
	return (
		<div className={`${scss.mainFilter}`} style={divStyle}>
			<h2>Filter</h2>
